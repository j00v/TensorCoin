...
from fake_stake.base_test import TensorCoin_FakeStakeTest

class zTNSRwrappedSerialsTest(TensorCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zTNSRs..." % DENOM_TO_USE)
