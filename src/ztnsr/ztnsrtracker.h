...
#ifndef TensorCoin_ZTNSRTRACKER_H
#define TensorCoin_ZTNSRTRACKER_H
...
public:
    CzTNSRTracker(std::string strWalletFile);
    ~CzTNSRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzTNSRWallet* zTNSRWallet = NULL);
...
#endif //TensorCoin_ZTNSRTRACKER_H
