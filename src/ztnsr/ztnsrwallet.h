...
#ifndef TensorCoin_ZTNSRWALLET_H
#define TensorCoin_ZTNSRWALLET_H
...
public:
    CzTNSRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZTNSR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZTNSR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //TensorCoin_ZTNSRWALLET_H
