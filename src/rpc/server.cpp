...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop TensorCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "TensorCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TensorCoin features */
        {"tensorcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"tensorcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tensorcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tensorcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"tensorcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"tensorcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"tensorcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tensorcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"tensorcoin", "startmasternode", &startmasternode, true, true, false},
        {"tensorcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tensorcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tensorcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tensorcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tensorcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tensorcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tensorcoin", "preparebudget", &preparebudget, true, true, false},
        {"tensorcoin", "submitbudget", &submitbudget, true, true, false},
        {"tensorcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tensorcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tensorcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tensorcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tensorcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tensorcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tensorcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tensorcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"tensorcoin", "mnsync", &mnsync, true, true, false},
        {"tensorcoin", "spork", &spork, true, true, false},
        {"tensorcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> tensorcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17773/\n";
}
