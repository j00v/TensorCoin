...
static const CAmount OBFUSCATION_POOL_MAX = (91999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 6000 TNSR - checking if valid masternode)
