...
public:
    ...
    bool CheckAndUpdate(int& nDos, bool fRequireEnabled = false, bool fCheckSigTimeOnly = false);
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 6000 TNSR, signature to prove
