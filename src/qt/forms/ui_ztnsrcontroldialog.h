/********************************************************************************
** Form generated from reading UI file 'ztnsrcontroldialog.ui'
**
...
#ifndef UI_ZTNSRCONTROLDIALOG_H
#define UI_ZTNSRCONTROLDIALOG_H
...
public:
    ...
    void setupUi(QDialog *ZTNSRControlDialog)
    {
        if (ZTNSRControlDialog->objectName().isEmpty())
            ZTNSRControlDialog->setObjectName(QStringLiteral("ZTNSRControlDialog"));
        ZTNSRControlDialog->resize(681, 550);
        ZTNSRControlDialog->setMinimumSize(QSize(681, 550));
        verticalLayout_1 = new QVBoxLayout(ZTNSRControlDialog);
        ...
        frame = new QFrame(ZTNSRControlDialog);
        ...
        labelZTNSR = new QLabel(layoutAmount);
        labelZTNSR->setObjectName(QStringLiteral("labelZTNSR"));

        horizontalLayout_9->addWidget(labelZTNSR);

        labelZTNSR_int = new QLabel(layoutAmount);
        labelZTNSR_int->setObjectName(QStringLiteral("labelZTNSR_int"));

        horizontalLayout_9->addWidget(labelZTNSR_int);
        ...
        __qtreewidgetitem->setText(3, QStringLiteral("zTNSR Version"));
        __qtreewidgetitem->setText(2, QStringLiteral("zTNSR ID"));
        ...
        retranslateUi(ZTNSRControlDialog);
        QObject::connect(buttonBox, SIGNAL(accepted()), ZTNSRControlDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), ZTNSRControlDialog, SLOT(reject()));

        QMetaObject::connectSlotsByName(ZTNSRControlDialog);
    } // setupUi

    void retranslateUi(QDialog *ZTNSRControlDialog)
    {
        ZTNSRControlDialog->setWindowTitle(QApplication::translate("ZTNSRControlDialog", "Select zTNSR to Spend", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("ZTNSRControlDialog", "Coin Control", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("ZTNSRControlDialog", "PushButton", Q_NULLPTR));
        labelZTNSR->setText(QApplication::translate("ZTNSRControlDialog", "zTNSR", Q_NULLPTR));
        labelZTNSR_int->setText(QApplication::translate("ZTNSRControlDialog", "0.00 ", Q_NULLPTR));
        labelQuantity->setText(QApplication::translate("ZTNSRControlDialog", "Quantity:", Q_NULLPTR));
        labelQuantity_int->setText(QApplication::translate("ZTNSRControlDialog", "0", Q_NULLPTR));
        pushButtonAll->setText(QApplication::translate("ZTNSRControlDialog", "Select/Deselect All", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(5, QApplication::translate("ZTNSRControlDialog", "Is Spendable", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ZTNSRControlDialog: public Ui_ZTNSRControlDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ZTNSRCONTROLDIALOG_H
