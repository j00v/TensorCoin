...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 TNSR"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 TNSR"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 TNSR"));
        ...
        checkzTNSR = new QCheckBox(frame_Send);
        checkzTNSR->setObjectName(QStringLiteral("checkzTNSR"));
        checkzTNSR->setEnabled(false);

        horizontalLayout_2->addWidget(checkzTNSR);
        ...
        labelBalance->setText(QStringLiteral("123.456 TNSR"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 TNSR", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkSwiftTX->setToolTip(QApplication::translate("SendCoinsDialog", "SwiftX technology allows for near instant transactions - A flat fee of 0.01 TNSR applies", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uTNSRs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uTNSRs in fee,<br />while \"at least\" pays 1000 uTNSRs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uTNSRs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uTNSRs in fee,<br />while \"total at least\" pays 1000 uTNSRs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for TensorCoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for TensorCoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzTNSR->setText(QApplication::translate("SendCoinsDialog", "Anonymized TNSR", Q_NULLPTR));
