...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->setWindowTitle(QStringLiteral("Tensor Coin - Command-line options"));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 561, 263));
...
"}"));
        ...
        pushButtonOk = new QPushButton(helpContainer);
