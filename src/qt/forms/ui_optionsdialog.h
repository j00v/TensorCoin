...
public:
    ...
    QWidget *verticalZtnsrOptionsWidget;
    QVBoxLayout *verticalZtnsrOptionsLayout;
    QHBoxLayout *horizontalAutomintingLayout;
    QCheckBox *checkBoxZeromintEnable;
    QCheckBox *checkBoxZeromintAddresses;
    QHBoxLayout *horizontalZmintPercentageLayout;
    ...
    QWidget *verticalZtnsrDisplayWidget;
    QVBoxLayout *verticalZtnsrDisplayLayout;
    QFrame *line;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        verticalZtnsrOptionsWidget = new QWidget(tabMain);
        verticalZtnsrOptionsWidget->setObjectName(QStringLiteral("verticalZtnsrOptionsWidget"));
        verticalZtnsrOptionsLayout = new QVBoxLayout(verticalZtnsrOptionsWidget);
        verticalZtnsrOptionsLayout->setContentsMargins(0, 0, 0, 0);
        verticalZtnsrOptionsLayout->setObjectName(QStringLiteral("verticalZtnsrOptionsLayout"));
        horizontalAutomintingLayout = new QHBoxLayout();
        horizontalAutomintingLayout->setObjectName(QStringLiteral("horizontalAutomintingLayout"));
        checkBoxZeromintEnable = new QCheckBox(verticalZtnsrOptionsWidget);
        ...
        horizontalAutomintingLayout->addWidget(checkBoxZeromintEnable);

        checkBoxZeromintAddresses = new QCheckBox(verticalZtnsrOptionsWidget);
        checkBoxZeromintAddresses->setObjectName(QStringLiteral("checkBoxZeromintAddresses"));
        checkBoxZeromintAddresses->setLayoutDirection(Qt::LeftToRight);

        horizontalAutomintingLayout->addWidget(checkBoxZeromintAddresses);


        verticalZtnsrOptionsLayout->addLayout(horizontalAutomintingLayout);

        horizontalZmintPercentageLayout = new QHBoxLayout();
        horizontalZmintPercentageLayout->setObjectName(QStringLiteral("horizontalZmintPercentageLayout"));
        percentage_label = new QLabel(verticalZtnsrOptionsWidget);
        percentage_label->setObjectName(QStringLiteral("percentage_label"));

        horizontalZmintPercentageLayout->addWidget(percentage_label);

        zeromintPercentage = new QSpinBox(verticalZtnsrOptionsWidget);
        ...
        horizontalZmintPercentageLayout->addWidget(zeromintPercentage);


        verticalZtnsrOptionsLayout->addLayout(horizontalZmintPercentageLayout);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setSizeConstraint(QLayout::SetFixedSize);
        labelPreferredDenom = new QLabel(verticalZtnsrOptionsWidget);
        ...
        preferredDenom = new QComboBox(verticalZtnsrOptionsWidget);
        ...
        verticalZtnsrOptionsLayout->addLayout(horizontalLayout);


        verticalLayout_Main->addWidget(verticalZtnsrOptionsWidget);
        ...
        verticalZtnsrDisplayWidget = new QWidget(tabDisplay);
        verticalZtnsrDisplayWidget->setObjectName(QStringLiteral("verticalZtnsrDisplayWidget"));
        verticalZtnsrDisplayLayout = new QVBoxLayout(verticalZtnsrDisplayWidget);
        verticalZtnsrDisplayLayout->setContentsMargins(0, 0, 0, 0);
        verticalZtnsrDisplayLayout->setObjectName(QStringLiteral("verticalZtnsrDisplayLayout"));
        line = new QFrame(verticalZtnsrDisplayWidget);
        line->setObjectName(QStringLiteral("line"));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);

        verticalZtnsrDisplayLayout->addWidget(line);
        ...
        unitLabel = new QLabel(verticalZtnsrDisplayWidget);
        ...
        unit = new QValueComboBox(verticalZtnsrDisplayWidget);
        unit->setObjectName(QStringLiteral("unit"));

        horizontalLayout_3_Display->addWidget(unit);


        verticalZtnsrDisplayLayout->addLayout(horizontalLayout_3_Display);
        ...
        checkBoxHideZeroBalances = new QCheckBox(verticalZtnsrDisplayWidget);
        ...
        checkBoxHideOrphans = new QCheckBox(verticalZtnsrDisplayWidget);
        ...
        verticalZtnsrDisplayLayout->addLayout(horizontalLayout_5_Display);
        ...
        thirdPartyTxUrlsLabel = new QLabel(verticalZtnsrDisplayWidget);
        ...
        thirdPartyTxUrls = new QLineEdit(verticalZtnsrDisplayWidget);
        thirdPartyTxUrls->setObjectName(QStringLiteral("thirdPartyTxUrls"));

        horizontalLayout_6_Display->addWidget(thirdPartyTxUrls);


        verticalZtnsrDisplayLayout->addLayout(horizontalLayout_6_Display);


        verticalLayout_Display->addWidget(verticalZtnsrDisplayWidget);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Tensor Coin after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Tensor Coin on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of TNSR units to zTNSR", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintEnable->setText(QApplication::translate("OptionsDialog", "Enable zTNSR Automint", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic zTNSR minting from specific addresses", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setText(QApplication::translate("OptionsDialog", "Enable Automint Addresses", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming TNSR which get automatically converted to zTNSR via Zerocoin Protocol (min: 10%)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        percentage_label->setText(QApplication::translate("OptionsDialog", "Percentage of autominted zTNSR", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelPreferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough TNSR for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelPreferredDenom->setText(QApplication::translate("OptionsDialog", "Preferred Automint zTNSR Denomination", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        preferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough TNSR for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Tensor Coin client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Tensor Coin network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Tensor Coin.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/tensorcoin-project/tensorcoin-project-translations", Q_NULLPTR));
