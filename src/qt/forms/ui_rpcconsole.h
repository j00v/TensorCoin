...
public:
    ...
    QLabel *wallet_customztnsrbackuppath_label;
    QLabel *wallet_customztnsrbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        gridLayout->addWidget(dataDir, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(networkName, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(numberOfConnectionsLabel, 10, 0, 1, 1);
        ...
        gridLayout->addWidget(masternodeCount, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(debugLogFileHeader, 17, 0, 1, 1);
        ...
        wallet_customztnsrbackuppath_label = new QLabel(tab_repair);
        wallet_customztnsrbackuppath_label->setObjectName(QStringLiteral("wallet_customztnsrbackuppath_label"));
        wallet_customztnsrbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customztnsrbackuppath_label, 4, 0, 1, 1);

        wallet_customztnsrbackuppath = new QLabel(tab_repair);
        wallet_customztnsrbackuppath->setObjectName(QStringLiteral("wallet_customztnsrbackuppath"));
        wallet_customztnsrbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customztnsrbackuppath->setVisible(false);
        wallet_customztnsrbackuppath->setTextFormat(Qt::PlainText);
        wallet_customztnsrbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_4->addWidget(wallet_customztnsrbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the TensorCoin debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customztnsrbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zTNSR Backup Path:", Q_NULLPTR));
        wallet_customztnsrbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
