                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTNSRPathCustom = GetArg("-ztnsrbackuppath", "");
    ...
    if(!strzTNSRPathCustom.empty()) {
        ui->wallet_customztnsrbackuppath->setText(QString::fromStdString(strzTNSRPathCustom));
        ui->wallet_customztnsrbackuppath_label->setVisible(true);
        ui->wallet_customztnsrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTNSRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Tensor Coin RPC console.") + "<br>" +
