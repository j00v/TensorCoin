...
#include "qt/tensorcoin/contactsdropdown.h"
#include "qt/tensorcoin/sendmultirow.h"
#include "qt/tensorcoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(TensorCoinGUI* parent);
    ~SendWidget();
