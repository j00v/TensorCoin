...
#include "qt/tensorcoin/forms/ui_receivewidget.h"
...
#include "qt/tensorcoin/furlistrow.h"
...
ReceiveWidget::ReceiveWidget(TensorCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive TNSR."));
