...
#include "qt/tensorcoin/settings/settingsnetworkwidget.h"
#include "qt/tensorcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tensorcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TensorCoinGUI* _window, QWidget *parent) :
