...
QT_MOC_LITERAL(1, 29, 14), // "onResetClicked"
QT_MOC_LITERAL(2, 44, 0) // ""

    },
    "SettingsDisplayOptionsWidget\0"
    "onResetClicked\0"
};
...
void SettingsDisplayOptionsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsDisplayOptionsWidget *_t = static_cast<SettingsDisplayOptionsWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SettingsDisplayOptionsWidget::staticMetaObject = {
    { &PWidget::staticMetaObject, qt_meta_stringdata_SettingsDisplayOptionsWidget.data,
      qt_meta_data_SettingsDisplayOptionsWidget,  qt_static_metacall, nullptr, nullptr}
};
