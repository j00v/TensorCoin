...
#include "qt/tensorcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(TensorCoinGUI* _window, QWidget *parent) :
