...
public:
    ...
    QHBoxLayout *horizontalPercentagezTNSR;
    QLabel *labelTitleUnit;
    QSpacerItem *horizontalSpacerPercentagezTNSR;
    QComboBox *comboBoxUnit;
    QSpacerItem *verticalDenomzTNSR;
    QHBoxLayout *horizontalDenomzTNSR;
    QLabel *labelTitleDigits;
    QSpacerItem *horizontalDenomzTNSR_1;
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezTNSR = new QHBoxLayout();
        horizontalPercentagezTNSR->setObjectName(QStringLiteral("horizontalPercentagezTNSR"));
        labelTitleUnit = new QLabel(left);
        labelTitleUnit->setObjectName(QStringLiteral("labelTitleUnit"));

        horizontalPercentagezTNSR->addWidget(labelTitleUnit);

        horizontalSpacerPercentagezTNSR = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalPercentagezTNSR->addItem(horizontalSpacerPercentagezTNSR);
        ...
        horizontalPercentagezTNSR->addWidget(comboBoxUnit);


        verticalLayout_2->addLayout(horizontalPercentagezTNSR);

        verticalDenomzTNSR = new QSpacerItem(20, 10, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalDenomzTNSR);

        horizontalDenomzTNSR = new QHBoxLayout();
        horizontalDenomzTNSR->setObjectName(QStringLiteral("horizontalDenomzTNSR"));
        labelTitleDigits = new QLabel(left);
        labelTitleDigits->setObjectName(QStringLiteral("labelTitleDigits"));

        horizontalDenomzTNSR->addWidget(labelTitleDigits);

        horizontalDenomzTNSR_1 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalDenomzTNSR->addItem(horizontalDenomzTNSR_1);
        ...
        horizontalDenomzTNSR->addWidget(comboBoxDigits);


        verticalLayout_2->addLayout(horizontalDenomzTNSR);
