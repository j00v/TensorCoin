...
#include "qt/tensorcoin/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(TensorCoinGUI* _window,QWidget *parent) :
