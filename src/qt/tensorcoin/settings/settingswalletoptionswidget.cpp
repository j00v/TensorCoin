...
#include "qt/tensorcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/tensorcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TensorCoinGUI* _window, QWidget *parent) :
