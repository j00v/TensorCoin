...
#include "qt/tensorcoin/furabstractlistitemdelegate.h"
#include "qt/tensorcoin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/tensorcoin/txviewholder.h"
...
#include "config/tensorcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalTNSR = 0;
    qint64 totalZtnsr = 0;
    QList<qreal> valuesTNSR;
    QList<qreal> valueszTNSR;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(TensorCoinGUI* _window);
    ~DashboardWidget();
