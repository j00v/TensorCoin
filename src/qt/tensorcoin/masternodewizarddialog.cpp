...
#include "qt/tensorcoin/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 17774");
    ...
    if(walletModel->isTestnet()){
        ...
        ui->lineEditPort->setText("27774");
    } else {
        ui->lineEditPort->setText("17774");
    }
...
bool MasterNodeWizardDialog::createMN(){
    if (walletModel) {
        ...
        3) send a tx with 6000 to that address.
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), "", CAmount(6000) * COIN, "");
