...
#include "qt/tensorcoin/forms/ui_coincontroltnsrwidget.h"

CoinControlTNSRWidget::CoinControlTNSRWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlTNSRWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select TNSR Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("TNSR");
    ...
    ui->labelValueAfter->setText("0.00 TNSR");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 TNSR");
    ui->labelValueFee->setText("0.00 TNSR");
...
CoinControlTNSRWidget::~CoinControlTNSRWidget()
{
    delete ui;
}
