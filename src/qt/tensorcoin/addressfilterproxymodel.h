...
#ifndef TensorCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TensorCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TensorCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
