...
#include "qt/tensorcoin/masternodeswidget.h"
#include "qt/tensorcoin/forms/ui_masternodeswidget.h"
#include "qt/tensorcoin/qtutils.h"
#include "qt/tensorcoin/mnrow.h"
#include "qt/tensorcoin/mninfodialog.h"

#include "qt/tensorcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(TensorCoinGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:17774 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 6000)){
            inform(tr("No enough balance to create a master node, 6000 TNSR required."));
            return;
        }
        showHideOp(true);
