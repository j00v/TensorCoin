...
public:
    ...
    void retranslateUi(QDialog *MasterNodeWizardDialog)
    {
        ...
        labelTitle1->setText(QApplication::translate("MasterNodeWizardDialog", "Create New Master Node Controller", Q_NULLPTR));
        labelMessage1a->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>To create a Tensor Coin Masternode you must dedicate 6000 TNSR (the unit of Tensor Coin) to the network (however, these coins are still yours and will never leave your possession). </p><p></p><p>You can deactivate the node and unlock the coins at any time.</p></body></html>", Q_NULLPTR));
        labelMessage1b->setText(QApplication::translate("MasterNodeWizardDialog", "Make sure you have this amount of coins.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("MasterNodeWizardDialog", "Set Master Node\342\200\231s Name", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>A transaction of 6000 TNSR will be made</p><p>to a new empty address in your wallet.</p><p>The Address is labeled under the master node's name.</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("MasterNodeWizardDialog", "Set Master Node\342\200\231s IP and port", Q_NULLPTR));
