...
"}"));
    ...
    void retranslateUi(QWidget *MnInfoDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("MnInfoDialog", "Master Node Information", Q_NULLPTR));
        ...
        textExport->setText(QApplication::translate("MnInfoDialog", "Export data to run the Master Node on a remote server", Q_NULLPTR));
