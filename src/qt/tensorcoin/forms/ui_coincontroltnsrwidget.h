/********************************************************************************
** Form generated from reading UI file 'coincontroltnsrwidget.ui'
**
...
#ifndef UI_COINCONTROLTNSRWIDGET_H
#define UI_COINCONTROLTNSRWIDGET_H
...
class Ui_CoinControlTNSRWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlTNSRWidget)
    {
        if (CoinControlTNSRWidget->objectName().isEmpty())
            CoinControlTNSRWidget->setObjectName(QStringLiteral("CoinControlTNSRWidget"));
        CoinControlTNSRWidget->resize(918, 552);
        CoinControlTNSRWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlTNSRWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlTNSRWidget);
        ...
        retranslateUi(CoinControlTNSRWidget);

        QMetaObject::connectSlotsByName(CoinControlTNSRWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlTNSRWidget)
    {
        CoinControlTNSRWidget->setWindowTitle(QApplication::translate("CoinControlTNSRWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlTNSRWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlTNSRWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlTNSRWidget", "TNSR:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlTNSRWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlTNSRWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlTNSRWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlTNSRWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlTNSRWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlTNSRWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlTNSRWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlTNSRWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlTNSRWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlTNSRWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlTNSRWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlTNSRWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlTNSRWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlTNSRWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlTNSRWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlTNSRWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlTNSRWidget: public Ui_CoinControlTNSRWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLTNSRWIDGET_H
