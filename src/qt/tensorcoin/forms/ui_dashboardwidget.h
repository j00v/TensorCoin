...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountTNSR = new QLabel(right);
        labelAmountTNSR->setObjectName(QStringLiteral("labelAmountTNSR"));
        labelAmountTNSR->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountTNSR);
        ...
        labelSquareTNSR = new QLabel(verticalWidgetChart);
        labelSquareTNSR->setObjectName(QStringLiteral("labelSquareTNSR"));
        labelSquareTNSR->setMinimumSize(QSize(14, 14));
        labelSquareTNSR->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquareTNSR);

        labelTNSR = new QLabel(verticalWidgetChart);
        labelTNSR->setObjectName(QStringLiteral("labelTNSR"));

        horizontalLayout_4->addWidget(labelTNSR);
        ...
        containerChartArrow->setMinimumSize(QSize(25, 0));
        containerChartArrow->setMaximumSize(QSize(25, 16777215));
...
"}"));
        ...
        pushButtonChartArrow = new QPushButton(containerChartArrow);
        pushButtonChartArrow->setObjectName(QStringLiteral("pushButtonChartArrow"));
        pushButtonChartArrow->setMinimumSize(QSize(20, 20));
        pushButtonChartArrow->setMaximumSize(QSize(20, 20));
        pushButtonChartArrow->setStyleSheet(QStringLiteral(""));

        verticalLayout_10->addWidget(pushButtonChartArrow);
...
"margin:0px;"));
        ...
        horizontalLayout_6 = new QHBoxLayout(containerSort);
        horizontalLayout_6->setSpacing(28);
        ...
        horizontalLayout_6->addWidget(groupBoxChart);
        ...
        horizontalLayout_6->addWidget(container_chart_dropboxes);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountTNSR->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking statistics", Q_NULLPTR));
        labelSquareTNSR->setText(QString());
        labelTNSR->setText(QApplication::translate("DashboardWidget", "TNSR", Q_NULLPTR));
