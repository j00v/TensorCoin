...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, TensorCoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, TensorCoinGUI *gui, double posX = 3);
