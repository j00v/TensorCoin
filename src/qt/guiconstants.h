...
/* TensorCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TensorCoin"
#define QAPP_ORG_DOMAIN "tensorcoin.org"
#define QAPP_APP_NAME_DEFAULT "TensorCoin-Qt"
#define QAPP_APP_NAME_TESTNET "TensorCoin-Qt-testnet"
