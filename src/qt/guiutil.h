...
/** Utility functions used by the TensorCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TensorCoin addresses in monospace font
...
// Parse "tensorcoin:" URI into recipient object, return true on successful parsing
