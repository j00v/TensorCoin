...
QT_MOC_LITERAL(4, 38, 17), // "updateTransaction"
QT_MOC_LITERAL(5, 56, 6), // "status"
QT_MOC_LITERAL(6, 63, 15), // "showTransaction"
QT_MOC_LITERAL(7, 79, 19), // "updateConfirmations"
QT_MOC_LITERAL(8, 99, 17), // "updateDisplayUnit"
QT_MOC_LITERAL(9, 117, 23), // "updateAmountColumnTitle"
QT_MOC_LITERAL(10, 141, 31), // "setProcessingQueuedTransactions"
QT_MOC_LITERAL(11, 173, 5) // "value"

    },
    "TransactionTableModel\0txArrived\0\0hash\0"
    "updateTransaction\0status\0showTransaction\0"
...
static const uint qt_meta_data_TransactionTableModel[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Bool,    3,    5,    6,
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void,
...
void TransactionTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->txArrived((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (TransactionTableModel::*_t)(const QString & );
...
// SIGNAL 0
void TransactionTableModel::txArrived(const QString & _t1)
{
