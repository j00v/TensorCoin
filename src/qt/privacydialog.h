...
public:
    ...
    void setZTNSRControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzTNSR_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTNSR_clicked();
    void on_pushButtonZTNSRControl_clicked();
