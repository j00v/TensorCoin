...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tensor Coin"),
     ...
     * override -datadir in the tensorcoin.conf file in the default data directory
     * (to be consistent with tensorcoind behavior)
     */
