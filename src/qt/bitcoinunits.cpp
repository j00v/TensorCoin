...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TNSR);
    unitlist.append(mTNSR);
    unitlist.append(uTNSR);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case TNSR:
        return QString("tensorcoin");
    case mTNSR:
        return QString("mtensorcoin");
    case uTNSR:
        return QString::fromUtf8("utensorcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TNSR:
            return QString("TNSR");
        case mTNSR:
            return QString("mTNSR");
        case uTNSR:
            return QString::fromUtf8("uTNSR");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TNSR:
            return QString("tTNSR");
        case mTNSR:
            return QString("mtTNSR");
        case uTNSR:
            return QString::fromUtf8("utTNSR");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TNSR:
            return QString("TNSR");
        case mTNSR:
            return QString("Milli-TNSR (1 / 1" THIN_SP_UTF8 "000)");
        case uTNSR:
            return QString("Micro-TNSR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TNSR:
            return QString("TestTNSRs");
        case mTNSR:
            return QString("Milli-TestTNSR (1 / 1" THIN_SP_UTF8 "000)");
        case uTNSR:
            return QString("Micro-TestTNSR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
