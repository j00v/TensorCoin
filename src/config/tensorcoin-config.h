/* src/config/tensorcoin-config.h.  Generated from tensorcoin-config.h.in by configure.  */
/* src/config/tensorcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TNSR_CONFIG_H

#define TNSR_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.tensorcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TensorCoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TensorCoin 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tensorcoin"
