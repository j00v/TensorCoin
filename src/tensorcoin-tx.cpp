...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tensor Coin tensorcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tensorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tensorcoin transaction") + "\n" +
                               "  tensorcoin-tx [options] -create [commands]   " + _("Create hex-encoded tensorcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tensorcoin transaction
