Contributing to TensorCoin
============================

The TensorCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/tensor-services/TensorCoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the TensorCoin project, and is not to be
confused with overall TensorCoin Network Protocol consensus changes.

Whether a pull request is merged into TensorCoin rests with the project merge
...
Patches that change TensorCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the TensorCoin consensus, it must have been
...
The project leader is the release manager for each TensorCoin release.
