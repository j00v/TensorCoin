...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/tensorcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/tensorcoin-cli.cpp \
           src/tensorcoin-tx.cpp \
           src/tensorcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/tensorcoin.qrc src/qt/tensorcoin_locale.qrc

TRANSLATIONS += src/qt/locale/tensorcoin_bg.ts \
                src/qt/locale/tensorcoin_de.ts \
                src/qt/locale/tensorcoin_en.ts \
                src/qt/locale/tensorcoin_es.ts \
                src/qt/locale/tensorcoin_fi.ts \
                src/qt/locale/tensorcoin_fr.ts \
                src/qt/locale/tensorcoin_it.ts \
                src/qt/locale/tensorcoin_ja.ts \
                src/qt/locale/tensorcoin_pl.ts \
                src/qt/locale/tensorcoin_pt.ts \
                src/qt/locale/tensorcoin_ru.ts \
                src/qt/locale/tensorcoin_sk.ts \
                src/qt/locale/tensorcoin_sv.ts \
                src/qt/locale/tensorcoin_vi.ts \
                src/qt/locale/tensorcoin_zh_CN.ts \
                src/qt/locale/tensorcoin_zh_TW.ts
